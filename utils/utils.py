...
def save_checkpoint_old(model, save_path):
    """Saves model when validation loss decreases."""
    torch.save(model.state_dict(), save_path)


def load_checkpointold(model, save_path):
...
#         'pos_vector': model.tstconv.pos_vector,  # 保存 pos_vector
#         'neg_vector': model.tstconv.neg_vector   # 保存 neg_vector
#     }
...
#     # 恢复 pos_vector 和 neg_vector
#     if 'pos_vector' in checkpoint:
#         model.tstconv.pos_vector = checkpoint['pos_vector']
#     if 'neg_vector' in checkpoint:
#         model.tstconv.neg_vector = checkpoint['neg_vector']
#     return model
